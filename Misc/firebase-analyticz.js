  ...
  try {
    (function () {
      ...
      function y(e, t, n) {
        ...
        return (
          ...
          Error.captureStackTrace &&
            Error.captureStackTrace(t, b.prototype.create),
          t
        );
      }
      var b =
      ...
      function C(e, t, n) {
        ...
        (n = t * Math.pow(n, e)),
          (e = Math.round(S * n * (Math.random() - 0.5) * 2));
              ...
              return Promise.resolve().then(function () {
                return (
                  ...
                  D(t._request).then(function (e) {
                    if (e) return new R(e, t._request);
                  })
                );
              });
            });
      ...
      var q = "0.4.19",
        ...
        $ =
          ...
          (Be["delete-pending-registration"] =
      ...
      function be() {
        ...
        return (
          ye ||
            ...
            (n = (e = P(indexedDB, "open", [ve, e])).request) &&
          ...
          return v(this, function (e) {
            switch (e.label) {
              ...
              case 1:
                return (
                  (r = e.sent()),
                  (n = r.transaction(me, "readwrite")),
                  [4, (r = n.objectStore(me)).get(t)]
                );
              case 2:
        ...
        return h(this, void 0, void 0, function () {
          ...
          return v(this, function (e) {
            switch (e.label) {
              ...
              case 7:
                return (
                  e.sent(), !o || (i && i.fid === o.fid) || ue(a, o.fid), [2, o]
                );
            }
          });
        });
            ...
            switch (e.label) {
              case 0:
                return [
                  4,
                  _e(i, function (e) {
                    (e = Se(e || { fid: oe(), registrationStatus: 0 })),
                      (e = (function (e, t) {
                        {
      ...
      function Te(e) {
        return _e(e, function (e) {
          if (!e) throw z.create("installation-not-found");
          return Se(e);
        });
      }
      function Se(e) {
        return 1 === (t = e).registrationStatus &&
          t.registrationTime + V < Date.now()
            ...
            return v(this, function (e) {
              switch (e.label) {
                case 0:
                  return [
                    4,
                    _e(i.appConfig, function (e) {
                      if (!De(e)) throw z.create("not-registered");
                      var t,
                        n = e.authToken;
                      if (
                        o ||
                        ...
                        (function (e) {
                          ...
                          return (
                            t < e.creationTime ||
                            e.creationTime + e.expiresIn < t + W
                          );
                        })(t)
                      ) {
      ...
      function Ne(e) {
        return _e(e, function (e) {
          if (!De(e)) throw z.create("not-registered");
          var t = e.authToken;
          return 1 === (t = t).requestStatus && t.requestTime + V < Date.now()
      ...
      function xe(e, r) {
        ...
        return (
          (function (e, t) {
            fe();
            var n = ae(e);
            (e = se.get(n)) || ((e = new Set()), se.set(n, e)), e.add(t);
          })(i, r),
          function () {
            var e, t, n;
            (t = r),
              (n = ae((e = i))),
              (e = se.get(n)) &&
                (e.delete(t), 0 === e.size && se.delete(n), de());
          }
        );
      }
      function ke(e) {
      ...
      (pe = t.default).INTERNAL.registerComponent(
        new O(
          "installations",
          function (e) {
            var t = e.getProvider("app").getImmediate(),
              n = {
                appConfig: (function (e) {
                  var t, n;
                  if (!e || !e.options) throw ke("App Configuration");
                  if (!e.name) throw ke("App Name");
                  try {
                    for (
                      ...
                      switch (e.label) {
                        ...
                        case 1:
                          return (
                            ...
                            (t.registrationPromise || Oe(r)).catch(
                              console.error
                            ),
                            [2, n.fid]
                          );
      ...
      var Re = {
        ...
        Me =
          ...
          $),
        Be =
          (Object.defineProperty(He.prototype, "logLevel", {
            get: function () {
          ...
          (He.prototype.debug = function () {
            ...
            this._userLogHandler &&
              this._userLogHandler.apply(this, je([this, he.DEBUG], e)),
          ...
          (He.prototype.log = function () {
            for (var e = [], t = 0; t < arguments.length; t++)
              e[t] = arguments[t];
            this._userLogHandler &&
              this._userLogHandler.apply(this, je([this, he.VERBOSE], e)),
          ...
          (He.prototype.info = function () {
            for (var e = [], t = 0; t < arguments.length; t++)
              e[t] = arguments[t];
            this._userLogHandler &&
              this._userLogHandler.apply(this, je([this, he.INFO], e)),
          ...
          (He.prototype.warn = function () {
            for (var e = [], t = 0; t < arguments.length; t++)
              e[t] = arguments[t];
            this._userLogHandler &&
              this._userLogHandler.apply(this, je([this, he.WARN], e)),
          ...
          (He.prototype.error = function () {
            for (var e = [], t = 0; t < arguments.length; t++)
              e[t] = arguments[t];
            this._userLogHandler &&
              this._userLogHandler.apply(this, je([this, he.ERROR], e)),
                                ...
                                return (
                                  (a =
                                    503 === Number(r.customData.httpStatus)
                                      ? C(p, f.intervalMillis, Xe)
                                      : C(p, f.intervalMillis)),
                                  (s = {
      ...
      var rt =
        ((it.prototype.addEventListener = function (e) {
                    ...
                    .then(function (e) {
                      (a[e.measurementId] = e.appId),
                        i.options.measurementId &&
                          e.measurementId !== i.options.measurementId &&
                          ze.warn(
                        ...
                        switch (e.label) {
                          case 0:
                            return f()
                              ? [3, 1]
                              : (ze.warn(
                                  Ye.create("indexeddb-unavailable", {
                                    errorInfo:
      ...
      var at,
        ...
        pt = !1;
      function ht(e) {
        if (pt) throw Ye.create("already-initialized");
      ...
      function vt(e, t) {
        (n = []),
          ...
          0 < n.length &&
            ((n = n
              ...
              .join(" ")),
            (n = Ye.create("invalid-analytics-context", { errorInfo: n })),
            ze.warn(n.message));
        var n,
          r,
          i,
          ...
          s,
          u = e.options.appId;
        if (!u) throw Ye.create("no-app-id");
        if (!e.options.apiKey) {
          if (!e.options.measurementId) throw Ye.create("no-api-key");
          ze.warn(
        ...
        if (null != ut[u]) throw Ye.create("already-exists", { id: u });
        return (
          pt ||
            ((function () {
              for (
                ...
                var r = n[t];
                if (r.src && r.src.includes($e)) return r;
              }
            })() ||
              ((a = ft),
                ...
                return h(this, void 0, void 0, function () {
                  ...
                  return v(this, function (e) {
                    switch (e.label) {
                      ...
                      case 2:
                        (t = e.sent()),
                          n(qe.CONFIG, t, { update: !0, screen_name: i }),
                          (e.label = 3);
                      case 3:
                        return [2];
                    }
                ...
                return h(this, void 0, void 0, function () {
                  ...
                  return v(this, function (e) {
                    switch (e.label) {
                      case 0:
                        return o && o.global
                          ? (n(qe.SET, { user_id: i }), [2, Promise.resolve()])
                          : [3, 1];
                      case 1:
                        return [4, r];
                      case 2:
                        (t = e.sent()),
                          n(qe.CONFIG, t, { update: !0, user_id: i }),
                          (e.label = 3);
                      case 3:
                        return [2];
                    }
                ...
                return h(this, void 0, void 0, function () {
                  ...
                  return v(this, function (e) {
                    switch (e.label) {
                      ...
                      case 2:
                        (o = e.sent()),
                          a(qe.CONFIG, o, { update: !0, user_properties: u }),
                          (e.label = 3);
                      case 3:
                        return [2];
                    }
      ...
      (gt = t.default).INTERNAL.registerComponent(
        new O(
          mt,
          function (e) {
            return vt(
          ...
          "PUBLIC"
        ).setServiceProps({ settings: ht, EventName: Ve, isSupported: yt })
      ),
        gt.INTERNAL.registerComponent(
          new O(
            "analytics-internal",
            function (e) {
              try {
                return { logEvent: e.getProvider(mt).getImmediate().logEvent };
              } catch (e) {
                throw Ye.create("interop-component-reg-failed", { reason: e });
              }
            },
            "PRIVATE"
          )
        ),
        gt.registerVersion("@firebase/analytics", "0.6.2");
    }.apply(this, arguments));
  } catch (e) {
    throw (
      (console.error(e),
